...
public class ClearEditText extends AppCompatEditText implements View.OnTouchListener,
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = getResources().getDrawable(R.mipmap.icon_shanchu);
        }

        mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth()-15,
                mClearDrawable.getIntrinsicHeight()-15);
        // 默认设置隐藏图标
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (mClearDrawable.isVisible() && x > getWidth() - getPaddingRight() - mClearDrawable
                .getIntrinsicWidth()) {
